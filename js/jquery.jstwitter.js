$(function() {
	...
	var searchterm = '';
	if (randomNum%2 == 0) {
			var searchterm = 'mestreesquilo';
			console.info("creating tweets for: "+searchterm);
	}else{
			var searchterm = 'cdocharlotte';
			console.info("creating tweets for: "+searchterm);
	}
	JQTWEET = {
	    ...
	    //user: 'mestreesquilo', //username
	    search: searchterm, //leave this blank if you want to show user's tweet
	    //search: 'mestreesquilo', //username
	    numTweets: 7, //number of tweets
	    appendTo: '#jstwitter',
