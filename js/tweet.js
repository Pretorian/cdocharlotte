...
(function($) {
  $.fn.tweet = function(o){
    ...
    function extract_template_data(item){
      ...
      o.text = t('<span class="tweet_text"> {tweet_text_fancy}</span> <span class="tweet_time">{tweet_relative_time} | <a class=" tweet_retweet" href="{retweet_url}">retweet</a></span>    ', o);
